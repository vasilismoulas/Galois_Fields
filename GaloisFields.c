        ...
        add2 = atoi(v);
         ...
         continue;      
           ...
           //* order
               ...
               //addition using the Zech method

                   if(strcmp(Zechorder,order) == 0)
                  {
                     int p,q = 0;
                             ...
                             printf("%d",log);
                                  ...
                                  tmp = arr[q-p+1];
                                    ...
                                    while(tmp!=NULL)                                  
                                   {
                                      ...
                                      //saving the binary number into an integer
                                       int bits,c1;
                                      for(int i = 0;i<n;i++){
                                    ...
                                    //Now we are implementing the a^(p+Z(q-p))
